 ...
 * Description: A program that will take a whole number and will print the corresponding number of * in a vertical line.
 */
  ...
  //^ This line of code opens the class
{
    ...
    //^ This line of code opens the main
  {
    ...
    for (int loop = 0; loop < number; loop++) //This loop uses the check-do-math method to solve how many * are needed to be outputted.
      ...
      System.out.println("*"); //Must be .println in order to print results vertically.
  }
}
